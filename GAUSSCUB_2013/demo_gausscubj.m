...
fprintf('\n \t [MODIFIED GAUSS-JACOBI LIKE FORMULA FOR POLYGONS][VERS. 4.0] [MARCH 7, 2007] \n');
...
%--------------------------------------------------------------------------
cputime1=cputime;
[cubature_result,x_nodes,y_nodes,weights]=polygaussj(@fct2D,N,polygon_sides,rotation,P,Q,[],cubature_type,function_type);
cputime2=cputime;
...
fprintf('\n \t [PGAUSSJ RESULT]: %5.15f',cubature_result); 
